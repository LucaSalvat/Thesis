\documentclass[a4paper,12pt,twoside,bachelor]{academicthesis} % Base class and layout options

% ----------------------------------------------------
% Core packages
% ----------------------------------------------------
\usepackage{times}  % Main serif font
\usepackage{lipsum} % Placeholder text for example content

% ----------------------------------------------------
% Thesis metadata (edit to match your project)
% ----------------------------------------------------
...
% Optional LUISS front-page tuning

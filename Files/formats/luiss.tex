% ------------------------------------------
% --------- Specific Error Handlign -------
% ------------------------------------------
\newcommand{\luiss@check@metadata}{%
	%\th@require{\th@department}{\department{Your Department}}
	\th@require@if{\ifth@bachelor}{\th@degree}{\degree{Your Degree}}
	\th@require@if{\ifth@master}{\th@degree}{\degree{Your Degree}}
	
	\th@require@if{\ifth@bachelor}{\th@chair}{\department{The Chair}}
	\th@require@if{\ifth@master}{\th@chair}{\department{The Chair}}
}

\AtBeginDocument{%
	\luiss@check@metadata
}
...
\define@key{luiss_front}{department-align}{\luiss@setalign{\luiss@phd_block@align}{#1}}


% General Command Luiss Definition 
\newcommand{\major}[1]{\gdef\luiss@major{#1}}
...
% Chair and Degree Box (bachelor/ Master)  -----
...
% Cycle and Department (PhD) ---------
\newcommand{\luiss@Cycle@Department}{%
	\noindent
	\luiss@alignedpar{%
		\LowerFont
		\myc@DepartmentOf~\th@department
		\linebreak\linebreak
		\myc@Phd~\th@phd 
		\linebreak\vspace*{0.02\textheight}\noindent 		
		\myc@Cycle~\th@cycle
	}{\luiss@phd_block@align}
}
...
% Drop Cap Color
\renewcommand{\LettrineFontHook}{\color{BlueLuiss}}
...
%------------------------------------------------------
%           FRONT PAGE (Master) same as bachelor
%------------------------------------------------------
...
\newcommand{\th@FrontPage@phd}{%
  \begin{titlepage}
	...
	% Department and Cycle box ----
    \luiss@Cycle@Department

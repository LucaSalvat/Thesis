...
% TO EVALUTE THE NAME FUNCTION
\newcommand{\luiss@namecolumn}[2]{% separate 2 entries with a line 
  \parbox[t]{0.33\textwidth}{%
    \centering
    \setlength{\parskip}{4pt}%
    \textbf{#1} \par
    \nointerlineskip
    \rule{0.33\textwidth}{0.2pt}\par
    \nointerlineskip
    #2%
  }%
}
...
\newcommand{\luiss@Author@Supervisor}{%Rendergin just Author and Supervisor
	...
	\luiss@namespacer%
	\luiss@namecolumn{\author@label}{\th@candidate}
}
...
\newcommand{\luiss@namesblock}{%
	\parbox{\textwidth}{%
		\ifdefempty{\th@cosupervisors}{% In case Supervisor Undefined
			\luiss@Author@Supervisor
		}{% In case Supervisor Defined

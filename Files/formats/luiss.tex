...
%------------- Names block (your structure) --------------
    \parbox{\textwidth}{%
  		\parbox[t]{0.33\textwidth}{% Supervisor
  		\centering
  		\setlength{\parskip}{4pt}
    	\textbf{\th@Supervisor@label}\par
  		\nointerlineskip
  		\rule{0.33\textwidth}{0.2pt}\par
  		\nointerlineskip
  		\th@supervisors
 	 }%
  	\parbox[t]{0.33\textwidth}{\hfill}% Empty Fill
  	\parbox[t]{0.33\textwidth}{\centering
  		\setlength{\parskip}{4pt}
    	\textbf{\author@label}\par
  		\nointerlineskip
  		\rule{0.33\textwidth}{0.2pt}\par
  		\nointerlineskip
  		\th@candidate

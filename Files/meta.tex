% ==========================================================
% STORAGE (defaults are EMPTY so validation is reliable)
% ==========================================================
\def\th@title{}
\def\th@subtitle{}
\def\th@candidate{}
...
\newcommand{\phd}[1]{\gdef\th@phd{#1}}
\newcommand{\cycle}[1]{\gdef\th@cycle{#1}}
...
\newcommand{\website}[1]{\gdef\th@AuthorWebsite{#1}}
...
% ==========================================================
% SUPERVISORS / CO-SUPERVISORS (list logic)
...
\newcommand{\Website}[1]{\website{#1}}
\newcommand{\Cycle}[1]{\cycle{#1}}
\newcommand{\PhD}[1]{\phd{#1}}

% ==========================================================
% Gender Case (list logic)
% ==========================================================
\newif\ifth@female
\th@femalefalse
...
% ==========================================================
% Single key command interface (thesis={...})
% ==========================================================
...
% ==========================================================
% Validation helpers (error checks for entries)
% ==========================================================
\newcommand{\th@error}[2]{%
...
\newcommand{\th@check@metadata}{%
  ...
  \th@require@if{\ifth@bachelor}{\th@degree}{\degree{Degree name}}%
  \th@require@if{\ifth@master}{\th@degree}{\degree{Degree name}}
  
  
  % Supervisors: if you want at least one supervisor required
  \th@require{\th@supervisors}{\supervisor{Prof. Name}}%
  
  % In case the thesis is a PhD thesis
  \th@require@if{\ifth@phd}{\th@cycle}{\cycle{XXXVI}}					%This is required for now just from luiss
  \th@require@if{\ifth@phd}{\th@department}{\department{Economics and Finance}}
  \th@require@if{\ifth@phd}{\th@phd}{\phd{Economics}}
  ...
  % ----- Mandatory entries for Front Page ---------

\documentclass[luiss,english,oneside]{academicthesis}
...
% ---------------- Dedication ---------------------
\dedication{%
To all students who choose \LaTeX{} not because it is easy, but because it is correct.
}

% ---------------- Abstract -----------------------
\begin{abstractthesis}
\lettrine{T}{his} document provides a complete, copyright-free example of a thesis
